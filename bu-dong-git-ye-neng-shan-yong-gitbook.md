# 不懂 Git 也能善用 GitBook {#%E4%B8%8D%E6%87%82-git-%E4%B9%9F%E8%83%BD%E5%96%84%E7%94%A8-gitbook}
...
### 先明白它的限制 {#%E5%85%88%E6%98%8E%E7%99%BD%E5%AE%83%E7%9A%84%E9%99%90%E5%88%B6}
...
### 使用編輯界面 {#%E4%BD%BF%E7%94%A8%E7%B7%A8%E8%BC%AF%E7%95%8C%E9%9D%A2}

然後，你大概就只會透過 GitBook 的編輯器編輯書籍了，請參考 [編輯界面](https://wastemobile.gitbooks.io/gitbook-chinese/content/editor/index.html) 一章的內容。

打開來是個線上三欄的編輯器：

![](https://www.gitbook.com/assets/images/backgrounds/preview_editor.png "Editor")

1. 中間是編輯區域，使用 Markdown 語法。
2. 左欄上方是章節目錄，按右鍵可以新增章節，拖放可以改變順序。
3. 左欄下方是檔案列表，按右鍵可以新增目錄或檔案。裡面必要且最重要的是 
   `README.md`
    與 
   `SUMMARY.md`
   。前者是你的書籍簡介，後者是決定書籍目錄真正的依據，例如想要製作多層次的目錄，目前左欄上方是還做不到的，你必須手動編輯 
   `SUMMARY.md`
   （但左欄上方會立即呈現結果）。
4. 右欄則是預覽視窗，也可以點擊工具列上的「小眼睛」暫時關閉它。試試看，事實上你可以關閉左欄清單與預覽預覽，像個極簡編輯器一樣專心寫作。

## 最重要的一件事！ {#%E6%9C%80%E9%87%8D%E8%A6%81%E7%9A%84%E4%B8%80%E4%BB%B6%E4%BA%8B%EF%BC%81}

![](https://wastemobile.gitbooks.io/gitbook-chinese/content/assets/master.png "master")
...
![](https://wastemobile.gitbooks.io/gitbook-chinese/content/assets/new-branch.png "Create New Branch")
...
![](https://wastemobile.gitbooks.io/gitbook-chinese/content/assets/merge.png "Merge")

會跳出一個視窗，輸入一些能提醒你自己的記錄文字：

![](https://wastemobile.gitbooks.io/gitbook-chinese/content/assets/merge-2.png "Merge 2")

接著你又收到另一個跳出的確認視窗：

![](https://wastemobile.gitbooks.io/gitbook-chinese/content/assets/remove.png "remove")
...
### 搭配目錄指引檔使用 {#%E6%90%AD%E9%85%8D%E7%9B%AE%E9%8C%84%E6%8C%87%E5%BC%95%E6%AA%94%E4%BD%BF%E7%94%A8}
